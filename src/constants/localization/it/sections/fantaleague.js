      ...
      tab: {
        general: {
          placeholder: {
            ...
            repeatedPlayer: 'Giocatori ripetuti',
            allowsAttackingMidfielder: 'Trequartisti',
            goalkeeper: 'Portieri',
            defender: 'Difensori',
            midfielder: 'Centrocampisti',
            attackingMidfielder: 'Trequartisti',
            striker: 'Attaccanti',
          },
          helperText: {
            ...
            allowsAttackingMidfielder: 'Puoi abilitare o disabilitare la possibilitá di giocare con i trequartisti',
            auction: 'Possibili opzioni per l\'asta',
            goalkeeper: 'Il numero dei portieri in rosa',
            defender: 'Il numero dei difensori in rosa',
            midfielder: 'Il numero dei centrocampisti in rosa',
            attackingMidfielder: 'Il numero dei trequartisti in rosa',
            striker: 'Il numero degli attaccanti in rosa',
          },
          options: {
            auction: {
              bid: 'Asta',
          ...
          teamComposition: {
            ...
            subtitle: 'Il numero di giocatori per ogni ruolo',
          },
        },
      },
    },
